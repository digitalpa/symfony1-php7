...
class sfValidatorString extends sfValidatorBase
{
  ...
  {
    $this->addMessage('max_length', 'err_max_length');//"%value%" is too long (%max_length% characters max).
    $this->addMessage('min_length', 'err_min_length');//"%value%" is too short (%min_length% characters min).
